...
function DocImageFloatingToolbar(props) {
  ...
  const wrappingStyleOptions = [
    { label: localeService.t("image-text-wrap.inline"), value: "inline" /* INLINE */, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWrapShapeIcon, {}) },
    { label: localeService.t("image-text-wrap.square"), value: "wrapSquare" /* WRAP_SQUARE */, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWrapShapeIcon, {}) },
    { label: localeService.t("image-text-wrap.topAndBottom"), value: "wrapTopAndBottom" /* WRAP_TOP_AND_BOTTOM */, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWrapShapeIcon, {}) },
    { label: localeService.t("image-text-wrap.behindText"), value: "behindText" /* BEHIND_TEXT */, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWrapShapeIcon, {}) },
    { label: localeService.t("image-text-wrap.inFrontText"), value: "inFrontOfText" /* IN_FRONT_OF_TEXT */, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWrapShapeIcon, {}) }
  ];
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToolbarGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            title: (_c = (_b = wrappingStyleOptions.find((option) => option.value === wrappingStyle)) == null ? void 0 : _b.label) != null ? _c : localeService.t("image-text-wrap.inline"),
            value: wrappingStyle,
